...
<div class="card">
    ...
    <div id="start-page">
        <h2>🔮 隱藏天賦潛能測試</h2>
        <p>你這輩子，其實帶了個隱藏天賦出生。憑直覺回答5道題，解鎖你潛意識裡的終極潛能與2026搞錢方向。</p>
    ...
    <div id="result-page" class="hidden">
        <h2>✨ 測試結果</h2>
        <div id="result"></div>
        <p style="margin-top:30px; color:#666; font-size:14px;">想要獲取精準的【3000字個人搞錢方向深度報告】？<br><b>請返回小紅書私信我「領取報告」！</b></p>
    </div>
</div>
...
<script>
    const questions = [
        ...
        { q: "4. 如果要你策劃一場聚會，你最不願意負責哪部分？", o: [{t:"安撫和照顧每個人當晚的情緒",v:"A"}, {t:"計算預算、行程記帳等繁瑣細節",v:"B"}, {t:"上台主持、帶動全場氣氛",v:"C"}, {t:"處理現場突發的停電或少定座位等意外",v:"D"}] },
        { q: "5. 想像你是一個探險家，你覺得哪種寶藏最吸引你？", o: [{t:"一本記錄古老失落文明的神秘日記",v:"A"}, {t:"一座運行精密、還能使用的古代機關城堡",v:"B"}, {t:"一顆傳說能給持有者帶來巨大名聲的寶石",v:"C"}, {t:"一具古代王者用來反敗為勝的絕密武器",v:"D"}] }
    ];
